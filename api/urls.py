...
router.register('tado/profile', TadoProfile, basename='tado-profile')
router.register('tado/home', TadoHome, basename='tado-homes')
router.register('enelogic/buildings', EnelogicBuilding, basename='enelogic-buildings')
router.register('enelogic/measuringpoints', EnelogicMeasuringPoints, basename='enelogic-measuringpoints')
router.register("enelogic/datapoints/days", EnelogicDataPointsDays, basename='enelogic-datapoints-days')
router.register("enelogic/datapoints/months", EnelogicDataPointsMonths, basename='enelogic-datapoints-months')
router.register("enelogic/datapoints", EnelogicDataPoints, basename='enelogic-datapoints')
